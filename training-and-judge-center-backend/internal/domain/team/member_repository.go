...
type MemberRepository interface {
	...
	FindByTeamAndUser(ctx context.Context, teamID string, userID shared.UserID) (*TeamMember, error)
	...
	DeleteByTeamAndUser(ctx context.Context, teamID string, userID shared.UserID) error
}
