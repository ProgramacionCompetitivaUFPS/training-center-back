...
func leadMemberRepo(groupID, userID string) *fakeMemberRepo {
	...
	lead, _ := domainGroup.NewGroupMember("m-lead", groupID, uid, domainGroup.MemberRoleLead, &uid, domainGroup.JoinMethodDirectAdd, nil)
...
func TestApproveRequest_AlreadyMemberReturns409(t *testing.T) {
	...
	existingMember, _ := domainGroup.NewGroupMember("m-existing", "g1", requesterUID, domainGroup.MemberRoleMember, nil, domainGroup.JoinMethodRequestApproved, nil)
