...
func TestGetGroup_UserProviderErrorReturnsInternal(t *testing.T) {
	...
	lead := domainGroup.RestoreGroupMember("m1", "g1", uidLead, domainGroup.MemberRoleLead, time.Now(), nil, domainGroup.JoinMethodDirectAdd, nil)
...
func TestGetGroup_NotVisibleReturnedToMember(t *testing.T) {
	...
	gm := domainGroup.RestoreGroupMember("m1", "g1", uid, domainGroup.MemberRoleMember, time.Now(), nil, domainGroup.JoinMethodDirectAdd, nil)
